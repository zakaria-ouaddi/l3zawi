...
class WorldWithJustinConfig(WorldConfig):
    ...
    def setup_world(self):
        ...
        torso2_joint: RevoluteConnection = self.world.joints[
            self.world.search_for_joint_name("torso2_joint")
        ]
        torso3_joint: RevoluteConnection = self.world.joints[
            self.world.search_for_joint_name("torso3_joint")
        ]
        torso4_joint: RevoluteConnection = self.world.joints[
            self.world.search_for_joint_name("torso4_joint")
        ]
        passive_torso_joint = JustinTorso(
            name=torso4_joint.name,
        ...
        self.set_joint_limits(
            limit_map={Derivatives.velocity: 0.2}, joint_name="torso1_joint"
        )
        self.set_joint_limits(
            limit_map={Derivatives.velocity: 0.2}, joint_name="torso2_joint"
        )
        self.set_joint_limits(
            limit_map={Derivatives.velocity: 0.2}, joint_name="torso3_joint"
        )
        self.world.register_group(
            "left_hand", root_link_name=self.world.search_for_link_name("left_arm7")
        )
        self.world.register_group(
            "right_hand", root_link_name=self.world.search_for_link_name("right_arm7")
        )
